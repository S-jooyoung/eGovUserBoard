...
public class RestEmployeeController {
	...
	// 전체적으로 예제 따라서 그냥 한거임
	// @GetMapping("/employee/list/{num}") 이렇게 써도 됨 이렇게 할거면 바로 아래에 getEmployeeDetail 참고 해보면 좋읗 듯
	...
	public List<HashMap> getEmployeeList(@RequestParam(required = false) HashMap<String, Object> param)
		...
		// 이건 구조 짜기 나름이라 안건들임 Postman같은 api테스트 하는걸로 데이터 어떻게 오는지 보고 니가 판단해서 넣는게 좋을 듯.
		return list;
	}
